  ...
  return (
    <div className="w-full h-[90vh] p-8">
      <div className="w-full bg-white h-full rounded flex items-center justify-center flex-col">
        ...
        <div
          className={`${styles.button} text-white !h-[42px] hover:scale-105 !rounded`}
            ...
            {paymentMethod ? (
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className={`${styles.button} mb-3 text-white hover:scale-105 hover:font-semibold hover:tracking-widest`}
                  >
                    Add
                  </button>
                </form>
                ...
                {seller && seller?.withdrawMethod ? (
                  ...
                  <div>
                    ...
                    <div className="w-full flex items-center">
                      <div
                        className={`${styles.button} text-[#fff] text-[18px] mt-4 hover:scale-105 hover:font-semibold `}
